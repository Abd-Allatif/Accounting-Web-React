...
function MainSellScreen() {
    ...
    return (<StyledWrapper>
        <BackGround className="Container">
            <TopBar drawerButton_Onclick={toggleDrawer(true)} buttonText={t("logout")} backButton_Onclick={logoutBtn} Text={t("sellSupplies")} />
            ...
            <Card className="ItemsContainer">
                ...
                <div className="Secondrow">
                    ...
                    <InputField placeholder={t("date")} type="date" className="SecondrowField" value={date} onChange={(e) => setDate(e.target.value)} />
                </div>
