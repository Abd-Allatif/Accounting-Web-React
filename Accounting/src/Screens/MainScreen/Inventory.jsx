    ...
    return (
        <StyledWrapper>
            <BackGround className="Container">
                <TopBar drawerButton_Onclick={toggleDrawer(true)} backButton_Onclick={backToMain} Text={t("inventory")} />
                <Drawer isOpen={isDrawerOpen} toggleDrawer={toggleDrawer} />

                <Card className="ItemsContainer">
                    <div className="Firstrow">
                        <div className="supplyField">
                            <InputField placeholder={t("supply")} type="text" value={supply} onChange={handleSearchSupplies}
                ...
                {selectedInventory && (
                    <div className='SubScreen'>
                        <Button className='SubScreenBtn' onClick={() => setSelectedInventory(null)}>{t("close")}</Button>
