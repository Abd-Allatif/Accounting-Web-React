        ...
        <Card className="NewCard">
          ...
          <div className='InputContainer'>
            ...
            <InputField autoComplete="off"
              ...
              placeholder={t("email")} type="text" value={email} onChange={(e) => setEmail(e.target.value.toLowerCase())} />

            <InputField autoComplete="off" placeholder={t("resetPasswordCode")} className="input-field" type="text" value={resetCode} onChange={(e) => setResetCode(e.target.value)} />

            <InputField placeholder={t("newPassword")}
          ...
          <div className="ButtonCotainer">
            <Button className="Reset" onClick={sendNewPassword} >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{t("reset")}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</Button>                    </div>
